...
<template>
  ...
  >
    <div
      v-show="show"
      ref="notiEl"
      class="pointer-events-auto max-w-sm overflow-hidden rounded-lg bg-primary shadow-lg ring-1 ring-black ring-opacity-5 transition-all"
      :class="positionClass"
    >
      <div class="p-4">
        <div class="flex items-center">
          ...
          <div class="ml-4 flex flex-shrink-0">
            <button
              class="inline-flex rounded-md text-xl text-primary focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2"
              @click="show = false"
            >
              <span class="sr-only">Close</span>
              <i
                class="ic-close flex items-center justify-center text-sm"
                aria-hidden="true"
              />
            </button>
          </div>
